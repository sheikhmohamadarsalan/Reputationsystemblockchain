...
class App extends Component {
  ...
  renderHelp() {
    if (this.state.showHelp) {
      let tip1 = "Click 'Rate!' to send a rating for a skill from an ethereum address.";
      let tip2 = "Click 'Get all ratings' to see a list of the submitted ratings.";
      let tip3 = "Click 'Rank all addresses' if you want to run the ranking algorithm and assign a 'reputation score' to each address, based how many ratings each skill has received.";
      let tip4 = "To get started, you can play around with these 10 addresses(with differents skills): ";
  ...
  render() {
    return (
      <div className="App">
              <h1>Social media ranking system</h1>
              <span className="subtitle">ranking Decentralized System &nbsp;</span>
              <a className="toggleHelp" onClick={() => this.toggleHelp()}>(help)</a>
              <div className="helpText">{this.renderHelp()}</div>
            <div >
              Submit a rating for an Ethereum address(Skills):
            </div>
